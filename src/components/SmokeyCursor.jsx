...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    const blit = (() => {
      ...
      if (!buffer) throw new Error("Failed to create ARRAY_BUFFER");
      ...
      if (!elemBuffer) throw new Error("Failed to create ELEMENT_ARRAY_BUFFER");
    ...
    function generateColor() {
      if (!autoColors) {
        return { r: backgroundColor.r * 0.15, g: backgroundColor.g * 0.15, b: backgroundColor.b * 0.15 };
      }
