...
function Dribble() {
  useGSAP(() => {
    ...
    mm.add("(max-width: 767px)", () => {
      // Mobile Animations (Simple left/right, no rotation)
      const tl = gsap.timeline({
        scrollTrigger: {
          trigger: ".dribble-left1",
          start: "top 80%",
          end: "bottom 20%",
          scrub: 1,
        },
      ...
      tl.to(".dribble-left1", { xPercent: -40, ease: "power1.inOut" }, 0)
        ...
        .to(".dribble-left2", { xPercent: -90, ease: "power1.inOut" }, 0.2)
        .to(".dribble-right2", { xPercent: 90, ease: "power1.inOut" }, 0.2)
        .to(".dribble-left3", { xPercent: -45, ease: "power1.inOut" }, 0.4)
        .to(".dribble-right3", { xPercent: 45, ease: "power1.inOut" }, 0.4);
  ...
  return (
    <div
      id="dribble-section"
      className="mt-20 z-10 relative min-h-[60vh] md:min-h-screen flex flex-col items-center justify-center "
    >
